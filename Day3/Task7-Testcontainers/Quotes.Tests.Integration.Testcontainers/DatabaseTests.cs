...
public sealed class DatabaseTests(SqlServerContainerFixture _fixture)
{
    [Fact]
    ...
    {
        using var firstFactory = new IntegrationTestFactory(_fixture.ConnectionString);
        ...
        using var secondFactory = new IntegrationTestFactory(_fixture.ConnectionString);
