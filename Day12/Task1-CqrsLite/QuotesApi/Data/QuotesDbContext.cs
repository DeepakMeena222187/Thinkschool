...
public sealed class QuotesDbContext(DbContextOptions<QuotesDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Maps to the existing dbo.EventLog table on QuotesApiDay7 (created and
        // seeded with 100k rows back in Day8) - no migration for this entity,
        // EF Core is only being taught about a table that already exists.
